...
#define FOUNDATION "B8QmLwwqmnHjHzuvTvxvNHotjqXb418nbF"
...
public:
    ...
    {
        // pitbull: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // pitbull: get transaction coin age
...
public:
    ...
    // pitbull: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // pitbull: two types of block: proof-of-work or proof-of-stake
    ...
    // pitbull: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // pitbull: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // pitbull: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // pitbull: block index flags
    enum  
    {
